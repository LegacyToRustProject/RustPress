...
| # | 条件 | 状態 |
|---|------|------|
| B-1 | WordPress上位100テーマが全て正常表示 | 計画中 |
| B-2 | WordPress上位50プラグインのデータが移行・表示可能 | 計画中 |
| B-3 | WP REST API v2が100%互換 | 開発中 |
| B-4 | 全ページでWordPressと97%+ピクセルマッチ | 開発中 |
| B-5 | `rustpress migrate` コマンド一発で5分以内に稼働 | 計画中 |
| B-6 | OWASP Top 10 全項目に対応 | 開発中 |
| B-7 | CI/CDが完全稼働 | 計画中 |
