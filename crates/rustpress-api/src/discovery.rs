...
async fn api_root(State(state): State<ApiState>) -> Json<Value> {
    ...
    routes.insert("/wp/v2/posts/(?P<id>[\\d]+)".into(), route("wp/v2", &["GET", "PUT", "DELETE"]));
    routes.insert("/wp/v2/pages".into(), route("wp/v2", &["GET", "POST"]));
    routes.insert("/wp/v2/pages/(?P<id>[\\d]+)".into(), route("wp/v2", &["GET", "PUT", "DELETE"]));
    routes.insert("/wp/v2/media".into(), route("wp/v2", &["GET", "POST"]));
    routes.insert("/wp/v2/media/(?P<id>[\\d]+)".into(), route("wp/v2", &["GET", "PUT", "DELETE"]));
    routes.insert("/wp/v2/categories".into(), route("wp/v2", &["GET", "POST"]));
    routes.insert("/wp/v2/categories/(?P<id>[\\d]+)".into(), route("wp/v2", &["GET", "PUT", "DELETE"]));
    routes.insert("/wp/v2/tags".into(), route("wp/v2", &["GET", "POST"]));
    routes.insert("/wp/v2/tags/(?P<id>[\\d]+)".into(), route("wp/v2", &["GET", "PUT", "DELETE"]));
    routes.insert("/wp/v2/users".into(), route("wp/v2", &["GET", "POST"]));
    routes.insert("/wp/v2/users/(?P<id>[\\d]+)".into(), route("wp/v2", &["GET", "PUT", "DELETE"]));
    routes.insert("/wp/v2/users/me".into(), route("wp/v2", &["GET"]));
    routes.insert("/wp/v2/comments".into(), route("wp/v2", &["GET", "POST"]));
    routes.insert("/wp/v2/comments/(?P<id>[\\d]+)".into(), route("wp/v2", &["GET", "PUT", "DELETE"]));
    routes.insert("/wp/v2/settings".into(), route("wp/v2", &["GET", "PUT"]));
    routes.insert("/wp/v2/types".into(), route("wp/v2", &["GET"]));
    routes.insert("/wp/v2/types/(?P<slug>[\\w-]+)".into(), route("wp/v2", &["GET"]));
    routes.insert("/wp/v2/taxonomies".into(), route("wp/v2", &["GET"]));
    routes.insert("/wp/v2/taxonomies/(?P<slug>[\\w-]+)".into(), route("wp/v2", &["GET"]));
    ...
    routes.insert("/wp/v2/menus/(?P<id>[\\d]+)".into(), route("wp/v2", &["GET", "PUT", "DELETE"]));
    routes.insert("/wp/v2/menu-items".into(), route("wp/v2", &["GET", "POST"]));
    routes.insert("/wp/v2/menu-items/(?P<id>[\\d]+)".into(), route("wp/v2", &["GET", "PUT", "DELETE"]));
    routes.insert("/wp/v2/themes".into(), route("wp/v2", &["GET"]));
    routes.insert("/wp/v2/themes/(?P<slug>[\\w-]+)".into(), route("wp/v2", &["GET"]));
    routes.insert("/wp/v2/plugins".into(), route("wp/v2", &["GET"]));
    routes.insert("/wp/v2/plugins/(?P<slug>[\\w-]+)".into(), route("wp/v2", &["GET"]));
    routes.insert("/wp/v2/sidebars".into(), route("wp/v2", &["GET"]));
    routes.insert("/wp/v2/sidebars/(?P<id>[\\w-]+)".into(), route("wp/v2", &["GET"]));
    routes.insert("/wp/v2/widgets".into(), route("wp/v2", &["GET"]));
    routes.insert("/wp/v2/widgets/(?P<id>[\\w-]+)".into(), route("wp/v2", &["GET"]));
    routes.insert("/wp/v2/posts/(?P<id>[\\d]+)/revisions".into(), route("wp/v2", &["GET"]));
    routes.insert("/wp/v2/posts/(?P<id>[\\d]+)/autosaves".into(), route("wp/v2", &["GET", "POST"]));
    routes.insert("/wp/v2/pages/(?P<id>[\\d]+)/autosaves".into(), route("wp/v2", &["GET", "POST"]));
