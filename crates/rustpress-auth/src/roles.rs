    ...
    pub fn capabilities(&self) -> HashSet<Capability> {
        ...
        match self {
            Role::Administrator => HashSet::from([
                EditPosts, EditOthersPosts, EditPublishedPosts, PublishPosts,
                DeletePosts, DeleteOthersPosts, DeletePublishedPosts,
                DeletePrivatePosts, EditPrivatePosts, ReadPrivatePosts,
                EditPages, EditOthersPages, EditPublishedPages, PublishPages,
                DeletePages, DeleteOthersPages, DeletePublishedPages,
                DeletePrivatePages, EditPrivatePages, ReadPrivatePages,
                ListUsers, CreateUsers, EditUsers, DeleteUsers, PromoteUsers,
                EditThemeOptions, SwitchThemes, EditThemes, DeleteThemes, InstallThemes,
                ActivatePlugins, EditPlugins, InstallPlugins, DeletePlugins,
                ManageOptions, ManageLinks, ManageCategories, ModerateComments,
                UploadFiles, Import, Export, Unfiltered, Read,
            ]),
            Role::Editor => HashSet::from([
                ...
                DeletePages, DeleteOthersPages, DeletePublishedPages,
                DeletePrivatePages, EditPrivatePages, ReadPrivatePages,
                ManageLinks, ManageCategories, ModerateComments,
                UploadFiles, Unfiltered, Read,
            ]),
            Role::Author => HashSet::from([
                EditPosts, EditPublishedPosts, PublishPosts,
                DeletePosts, DeletePublishedPosts,
                UploadFiles, Read,
            ]),
            Role::Contributor => HashSet::from([
                EditPosts, DeletePosts, Read,
            ]),
...
mod tests {
    ...
    fn test_current_user_can() {
        assert!(current_user_can("administrator", &Capability::ManageOptions));
